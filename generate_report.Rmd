...
title: | 
  ...
  | \vspace{-0.05cm} \Large `r paste("geboren am", data$geb)` 

date: `r format(Sys.Date(), "%d.%m.%Y")`
---
```{r, message=FALSE, echo=FALSE, include=FALSE}
# preprocessing of the data coming from REDCap
...
# first, filter the ID we want to generate the report for
...
# generate PID plot
PID_data <- data %>%
  mutate(pid_gesamt = pid_gesamt/5) %>%
  select(matches("pid")) %>%
